...
namespace DeluxeOM.Repository
{
    ...
    public partial class DeluxeOrderManagementEntities : DbContext
    {
        ...
        public virtual DbSet<BulkUpdate_Validations> BulkUpdate_Validations { get; set; }
        ...
        public virtual int usp_BulkUpdateOrder(string filePath, Nullable<int> userId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_BulkUpdateOrder", filePathParameter, userIdParameter);
        }
    
        public virtual int usp_UpdateOG_Status(string orderId)
        {
