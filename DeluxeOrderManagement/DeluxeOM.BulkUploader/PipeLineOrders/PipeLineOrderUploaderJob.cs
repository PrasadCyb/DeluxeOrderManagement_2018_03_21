...
namespace DeluxeOM.PO.BulkUploader
{
    ...
    /// <summary>
    /// Methods for process PipeLine order task
    /// </summary>
    public class PipeLineOrderUploaderJob : IJob
    {
        ...
        /// <summary>
        /// Initialize task for PipeLine order
        /// </summary>
        /// <param name="tasks">Tasks for PipeLine order</param>
        ...
        /// <summary>
        /// Process all task of PipeLine order
        /// </summary>
        /// <returns>JobStaus</returns>
