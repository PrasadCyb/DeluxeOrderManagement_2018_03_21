...
rh.consts('DEFAULT_TOPIC', encodeURI("#Introduction/Introduction.htm".substring(1)));
rh.consts('HOME_FILEPATH', encodeURI("index.htm"));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', '5AAC301B-66DD-4F87-9C30-1BD492E45385' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "Deluxe Avails v1.0");
